...
For accuracy, please make sure to **only use the official boxing undercard** when inputting data.
...
def read_data():
    ...
    # csv file path
    my_file_path = Path(curr_dir + "/streamlit-deployable-cloud/data/fight_data.csv")
    ...
    backup_file_path = Path(curr_dir + "/streamlit-deployable-cloud/data/fight_data_backup_basic.csv")
...
curr_dir = os.getcwd()
xgbc_path = Path(curr_dir + '/streamlit-deployable-cloud/models/basic_xgboost.pkl')
